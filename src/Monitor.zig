...
pub const ErrorCode = enum(zig.DefaultEnumType) {
    ...
    io_device_str = c.WWISEC_AK_Monitor_ErrorCode_IODeviceStr,
    ...
    activity_playback_warning = c.WWISEC_AK_Monitor_ErrorCode_ActivityPlayback_Warning,
    cannot_play_source_file_access = c.WWISEC_AK_Monitor_ErrorCode_CannotPlaySource_FileAccess,
    media_discrepancy = c.WWISEC_AK_Monitor_ErrorCode_MediaDiscrepancy,
