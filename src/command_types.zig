...
pub fn AkCommandTemplate(comptime BackingType: type) type {
...
pub const AkCommand = AkCommandTemplate(zig.DefaultEnumType);
pub const AkCommand_u16 = AkCommandTemplate(u16);
...
pub const AkCmd_SetPosition = extern struct {
    ...
    flags: enums.AkSetPositionFlags align(1) = .default,
...
pub const AkCommandHeader = extern struct {
    code: AkCommand_u16 = .end_of_buffer,
    size: u16 = 0,
    flags: u16 = 0,
    result: enums.AKRESULT_u16 = .success,
...
pub const AkCommandBufferIterator = extern struct {
    ...
    pub fn next(self: *AkCommandBufferIterator) bool {
        return c.AK_CommandBuffer_Next(@ptrCast(self)) > 0;
    }
