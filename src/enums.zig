...
pub fn AKRESULT_Template(comptime BackingType: type) type {
...
pub const AKRESULT = AKRESULT_Template(zig.DefaultEnumType);
pub const AKRESULT_u16 = AKRESULT_Template(u16);
