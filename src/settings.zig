...
pub const AkInitSettings = struct {
    ...
    pub fn fromC(allocator: std.mem.Allocator, value: c.WWISEC_AkInitSettings) !AkInitSettings {
        return .{
            ...
            .plugin_dll_path = if (value.szPluginDLLPath != null) try zig.fromOSChar(allocator, value.szPluginDLLPath) else null,
    ...
    pub fn toC(self: AkInitSettings, allocator: std.mem.Allocator) !c.WWISEC_AkInitSettings {
        return .{
            ...
            .szPluginDLLPath = if (self.plugin_dll_path != null) @ptrCast(try zig.toOSChar(allocator, self.plugin_dll_path.?)) else null,
